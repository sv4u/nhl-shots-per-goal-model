...
holtby_game_trend = data.frame(x = c(1:length(holtby_spg_games)),
							   y = holtby_spg_games)
plot = ggplot(holtby_game_trend, aes(x, y)) +
	geom_point(color = "#041E42") +
	geom_smooth(method = "lm", color = "#C8102E", fill = "#C8102E") +
	labs(title = "Braden Holtby SPG by Game", x = "Game Played", y = "SPG") +
	theme_minimal()
plot
```
